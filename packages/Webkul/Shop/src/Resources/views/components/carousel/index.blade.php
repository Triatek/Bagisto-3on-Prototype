...
<v-carousel :images="{{ json_encode($options['images'] ?? []) }}">
    <div class="overflow-hidden">
        <div class="shimmer aspect-[2.3/1] max-h-screen w-screen"></div>
    </div>
</v-carousel>
            ...
            >
                ...
                >
                    <x-shop::media.images.lazy
                        class="aspect-[2.3/1] max-h-full w-full max-w-full select-none transition-transform duration-300 ease-in-out will-change-transform"
