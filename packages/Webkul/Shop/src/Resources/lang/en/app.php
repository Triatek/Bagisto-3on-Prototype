    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'summary' => [
                ...
                'estimate-shipping' => [
                    ...
                    'check-shipping-cost'  => 'Check Shipping Cost',
                    'country'              => 'Country',
                    'info'                 => 'Enter your destination to get a shipping and tax estimate.',
                    'loading'              => 'Loading...',
                    'postcode'             => 'Zip/Postcode',
                    'postcode-placeholder' => 'Example: 40123',
                    'select-city'          => 'Select City',
                    'select-country'       => 'Select Country',
                    'select-courier'       => '-- Select Courier --',
                    'select-province'      => 'Select Province',
                    'select-service'       => 'Select Shipping Service:',
        ...
        'onepage' => [
            'address' => [
                ...
                'first-name'             => 'First Name',
                'full-name'              => 'Full Name',
                'full-name-placeholder'  => 'Recipient Full Name',
                'last-name'              => 'Last Name',
                'loading'                => 'Loading...',
                'postcode'               => 'Zip/Postcode',
                'proceed'                => 'Proceed',
